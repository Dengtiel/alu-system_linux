...
/**
 * syscalls - table of x86_64 syscall numbers, names and arg counts
 * nargs: -1 = variadic (print ...)
 */
...
/**
 * get_syscall_nargs - look up argument count for a syscall
 * @num: the syscall number
 *
 * Return: number of args, -1 if variadic, 0 if not found
 */
